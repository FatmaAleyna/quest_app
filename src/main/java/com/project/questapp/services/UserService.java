...
public class UserService {
	...
	public UserService(UserRepository userRepository, @Lazy LikeRepository likeRepository,
					  @Lazy CommentRepository commentRepository, @Lazy PostRepository postRepository) {
